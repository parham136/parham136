...
echo '<h2 style="color: #2d7cff !important; font-family: "Poppins", sans-serif !important;">'.sprintf(esc_html__('Order #%1$s (%2$s)', 'woocommerce'), $order->get_order_number(), wc_format_datetime($order->get_date_created())).'</h2>'."\n";
